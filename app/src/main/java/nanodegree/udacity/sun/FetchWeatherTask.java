...
import nanodegree.udacity.sun.data.WeatherContract;
...
public class FetchWeatherTask extends AsyncTask<String, Void, String[]> {
    ...
    private String formatHighLows(double high, double low) {
        ...
        if (!unitType.equals("metric")) {
            high = (high * 1.8) + 32;
            low = (low * 1.8) + 32;
        } else if (!unitType.equals(mContext.getString(R.string.pref_units_key))) {
    ...
    private String[] getWeatherDataFromJson(String forecastJsonStr,
        ...
        try {
            ...
            for(int i = 0; i < weatherArray.length(); i++) {
                ...
                weatherValues.put(WeatherContract.WeatherEntry.COLUMN_SHORT_DESCRIPTION, description);
